...
class GetNextEventUseCase@Inject constructor (private val repository: EventRepository, @IoDispatcher dispatcher: MainCoroutineDispatcher) : FlowUseCase<Unit,Event>(dispatcher) {
