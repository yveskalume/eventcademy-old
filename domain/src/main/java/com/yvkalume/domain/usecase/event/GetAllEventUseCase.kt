...
class GetAllEventUseCase @Inject constructor (private val repository: EventRepository, @IoDispatcher dispatcher: CoroutineDispatcher) : FlowUseCase<Unit, List<Event>>(dispatcher) {
